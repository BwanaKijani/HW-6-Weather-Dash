...
// store api key
const apiKey = "&appid=91a49fc1d36c35421107a53b3f87c750";
const lat = 0;
const lon =0;
const vindex = 0;
let date = new Date();
...
$("#searchBtn").on("click", () => {
        ...
        $.ajax({
            ...
            .then(function (response) {
                ...
                const queryUvi = "http://api.openweathermap.org/data/2.5/uvi?" + lat + "&lon=" + lon  + apiKey;
                $.ajax({
                  url: queryUvi,
                  method: "GET"
              })
...
$("#list-group-item").on("click", function(event) {
  ...
  function getCurrentConditions (response) {
    ...
    cardBody.append(city, temperature, humidity, wind,precip, uvi);
